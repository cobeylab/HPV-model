...
make_pomp_panel <- function(i, infection_data = data, times_data = times, covariates = covartable, n_cov = n_covariates, test_params = guess, rprocess = rprocess_additional_risk, init = init_additional_risk ){
